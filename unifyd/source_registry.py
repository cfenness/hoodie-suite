...
SOURCES = [
    ...
    dict(id="kroger", label="Kroger", code="import kroger_api as m; m.main()",
         tables=["kroger_products"], klass="creds", cadence="daily", enabled=True, note="Kroger API creds (term x zip)"),
    ...
    dict(id="census", label="US Census ACS", code="import census_ref as m; m.build()",
         tables=["census_reference"], klass="creds", cadence="weekly", enabled=True, note="Census API (census_ref.build)"),
