# Master quality (P/R vs gold) — `build-master-quality`
...
|  |  |
|---|---|
| Registry id | `build-master-quality` |
| Runs | `import master_quality as m; m.build()` |
...
**Registry note.** deterministic UPC/brand gold → precision/recall/F1 of item_key merges + regression flag
